[![Build Status](https://dev.azure.com/MoshuTech/Python/_apis/build/status/MKBN.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/MoshuTech/Python/_build/latest?definitionId=9&branchName=master)
